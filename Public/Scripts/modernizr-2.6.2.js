...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function webforms() {
        ...
        // spec: www.whatwg.org/specs/websites-apps/current-work/multipage/the-input-element.html#input-type-attr-summary
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      bool =  defaultView.getComputedStyle &&
                              ...
                              // Mobile android websites browser has false positive, so must
